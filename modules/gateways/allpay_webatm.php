...
function allpay_webatm_MetaData() {
    return array(
        'DisplayName' => '歐付寶 - WebATM',
...
function allpay_webatm_link($params) {
    ...
    $transaction = new AllPay_Pay('WebATM');
    ...
    $transaction->ReturnURL = rtrim($systemurl, '/').'/modules/gateways/callback/allpay_webatm.php';
